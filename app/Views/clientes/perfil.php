          ...
          <div class="card-body box-profile">
            <div class="text-center">
              <img class="profile-user-img img-fluid img-circle"
                src="<?= $cliente['imagem'] ? base_url('uploads/clientes/' . $cliente['imagem']) : base_url('assets/img/avatar-default.png') ?>"
                alt="Foto do Cliente">
            </div>
            <h3 class="profile-username text-center"><?= esc($cliente['nome']) ?></h3>
            <p class="text-muted text-center"><?= esc($cliente['email']) ?></p>
            <ul class="list-group list-group-unbordered mb-3">
              <li class="list-group-item">
                <b>Data de nascimento</b> <span class="float-right"><?= date('d/m/Y', strtotime($cliente['data_nascimento'])) ?></span>
              </li>
              <li class="list-group-item">
                <b>Status</b>
                <span class="float-right badge badge-<?= $cliente['status'] === 'ativo' ? 'success' : 'secondary' ?>">
                  <?= esc($cliente['status']) ?>
                </span>
              </li>
            </ul>
            <a href="<?= base_url('clientes/edit/' . $cliente['id']) ?>" class="btn btn-primary btn-block"><b>Editar Cliente</b></a>
          </div>
        </div>
      </div>
